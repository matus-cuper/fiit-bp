...
robotnice (employed bees), prehľadávačky (onlookers) a prieskúmníčky (scouts).
Informácie o zdrojoch potravy si vymieňajú
tancovaním (waggle dance) na tzv. tanečnej ploche. Prehľadávačky čakajúce na tanečnej
ploche sa rozhodujú, ktorý zdroj potravy si vyberú. Robotnice navštevujú zdroje
potravy, ktoré v minulosti už navštívili. Úlohou včiel priskumníčok je
...
pridávajú ďalšie algortimy sa nachádzajú v adresári \texttt{\textit{conf}}. Zdrojové kódy,
...
\begin{figure}[ht]
  ...
  \caption{Dátum a čas pred potrebnou transformáciou.}
  \label{fig-rf-raw}
\end{figure}
...
Pri implmentácií funkcií \texttt{\textit{predictFn}} a \texttt{\textit{predictDataFn}} je dôležité myslieť
...
z inteligentných elektromeračov, vďaka ktorým máme dáta k dispozícií každu
...
bude zabezpečovať dostatočne rýchly výpočet s uspokojujúcov veľkosťou chyby.
...
medzi jednotlivými parametrami. Merania potvrdili závilosť nájdeného riešenia od
