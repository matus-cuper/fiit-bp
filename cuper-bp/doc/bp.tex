...
%-------------------------------------------------------------------------------
%   Prediction comparison with different fitness functions
%-------------------------------------------------------------------------------
...
\subsection{Nastavenie parametrov optimalizačných metód}
\label{test-setup}

\begin{table}[!ht]
  \centering
  \caption{Parametre optimalizačných metód pri SVR.}
  \label{tab-test-svr-setup}
  \begin{tabular}{|l|c|c|c|c|c|}
    \hline
    \textbf{Označenie}  &   \begin{tabular}[x]{@{}c@{}}\textbf{Maximum} \\ \textbf{iterácií}\end{tabular} 	  &   \begin{tabular}[x]{@{}c@{}}\textbf{Počet častíc/} \\ \textbf{zdrojov potravy}\end{tabular}		&   \textbf{Limit}  	&   \textbf{C}		&   \textbf{epsilon}   \\ \hline
		T1    &    10				&		 20			&    5			&		 20-50			&    0-10				\\ \hline
		T2	  &    20				&    50			&    10			&		 50-200			&    0-5				\\ \hline
		T3		&		 20				&    20			&    10			&		 200-300		&    10-15			\\ \hline
		T4		&		 20				&    20			&    10			&		 400-500		&    10-30			\\ \hline
  \end{tabular}
\end{table}

\begin{table}[!ht]
  \centering
  \caption{Parametre optimalizačných metód pri modeli ARIMA.}
  \label{tab-test-arima-setup}
  \begin{tabular}{|l|c|c|c|c|c|c|}
    \hline
    \textbf{Označenie}  &   \begin{tabular}[x]{@{}c@{}}\textbf{Maximum} \\ \textbf{iterácií}\end{tabular} 	  &   \begin{tabular}[x]{@{}c@{}}\textbf{Počet častíc/} \\ \textbf{zdrojov potravy}\end{tabular}		&   \textbf{Limit}  	&   \textbf{p}		&   \textbf{d}		 &			\textbf{q}   \\ \hline
		T5    &    20				&		 10			&    10			&		 1-4			&    1-4			&		1-4			\\ \hline
		T6	  &    10				&    20			&    5			&		 0-3			&    0-3			&		0-3			\\ \hline
		T7		&		 20				&    20			&    NA			&		 0-3			&		 1-5			&   0-3			\\ \hline
  \end{tabular}
\end{table}

\begin{table}[!ht]
  \centering
  \caption{Parametre optimalizačných metód pri náhodných lesoch.}
  \label{tab-test-rf-setup}
  \begin{tabular}{|l|c|c|c|c|c|}
    \hline
    \textbf{Označenie}  &   \begin{tabular}[x]{@{}c@{}}\textbf{Maximum} \\ \textbf{iterácií}\end{tabular} 	  &   \begin{tabular}[x]{@{}c@{}}\textbf{Počet častíc/} \\ \textbf{zdrojov potravy}\end{tabular}		&   \textbf{Limit}  	&   \begin{tabular}[x]{@{}c@{}}\textbf{Počet} \\ \textbf{stromov}\end{tabular}		&   \begin{tabular}[x]{@{}c@{}}\textbf{Veľkosť} \\ \textbf{uzla}\end{tabular}   \\ \hline
		T8    &    100			&		 20			&    20			&		 5-20			&    40-80			\\ \hline
		T9	  &    100			&    20			&    10			&		 5-20			&    80-200			\\ \hline
		T10		&		 100			&    20			&    10			&		 1-40			&    1-250			\\ \hline
		T11		&		 100			&    50			&    20			&		 7-15			&    1-400			\\ \hline
  \end{tabular}
\end{table}

\begin{table}[!ht]
  \centering
  \caption{Parametre PSO a náhodných lesov pri rôznych fitness funkciách.}
  \label{tab-test-fitness-setup}
  \begin{tabular}{|l|c|c|c|c|c|}
    \hline
    \textbf{Označenie}  &   \begin{tabular}[x]{@{}c@{}}\textbf{Maximum} \\ \textbf{iterácií}\end{tabular} 	  &   \begin{tabular}[x]{@{}c@{}}\textbf{Počet častíc/} \\ \textbf{zdrojov potravy}\end{tabular}		&   \textbf{Limit}  	&   \begin{tabular}[x]{@{}c@{}}\textbf{Počet} \\ \textbf{stromov}\end{tabular}		&   \begin{tabular}[x]{@{}c@{}}\textbf{Veľkosť} \\ \textbf{uzla}\end{tabular}   \\ \hline
		T12   &    100			&		 20			&    20			&		 5-20			&    40-80			\\ \hline
		T13	  &    100			&    20			&    10			&		 5-20			&    80-200			\\ \hline
		T14		&		 100			&    20			&    10			&		 1-40			&    1-250			\\ \hline
		T15		&		 100			&    50			&    20			&		 7-15			&    1-400			\\ \hline
  \end{tabular}
\end{table}

\newpage
\subsection{Výsledky meraní}
\label{test-result}

\begin{table}[!ht]
  \centering
  \caption{Výsledky predpovedí SVR.}
  \label{tab-test-svr-result}
  \begin{tabular}{|c|r|r|r|r|r|r|r|}
    \hline
		\multicolumn{2}{|c|}{}									&			\multicolumn{2}{|c|}{\textbf{Veľkosť chyby}}		&					\multicolumn{2}{|c|}{\textbf{C}}				&			\multicolumn{2}{|c|}{\textbf{epsilon}} \\ \hline
		...
		T1-D1 PSO		&		198.18	&		8089.35		&		0			&		50		&		0		&		0.02		&		0.08 	 \\ \hline
		T1-D2 PSO		&		195.77	&		6459.48		&		0.06	&		50		&		0		&		9.74		&		0.83 	 \\ \hline
		T1-D3 PSO		&		202.36	&		3888.73		&		0			&		50		&		0		&		10			&		0 	 	 \\ \hline
...
\begin{table}[!h]
  ...
  \begin{tabular}{||l|p{0.65\textwidth}||}
    ...
    7. týždeň    &  ošetrenie neplatných akcií vykonaných používateľom                                        \\ \hline
...
% support vector sú koordináty jednotlivých meraní napríklad muž a žena a ich merané veličny reprezentované na osy, ktoré sú hraničnými elementami rôznych skupín
...
% charakter a dĺžka cyklu sa viaže napríklad ku dňu, týždnu či roku. Nepravidelná
...
% Pri predpovedaní časových radov ako napríklad meraní odberu elektriky vznikajú 2 typy tvz. Concept drift.
...
% hodnotu z rovnakého obdobia, napríklad z minulého roka~\cite{Grmanova2016}.
%
...
% Tento problém môžeme vyriešiť kombináciou ostatných metód, ako je napríklad
