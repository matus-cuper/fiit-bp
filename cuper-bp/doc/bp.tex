...
\begin{figure}[!ht]
  ...
  \label{fig-multi-model}
	\source{Eurostat - Index stavebnej produkcie Slovenska}
\end{figure}
...
\begin{table}[ht]
  \centering
  \caption{Porovnanie predikcii náhodných lesoch pre rôzne veľké trénovacie množiny}
...
Vyskúšam či výsledné nájdené parametre ovplyvním zmenou fitness funkcie
