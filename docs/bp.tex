...
jej meranie. Označuje sa aj ako náhodná zložka alebo biely šum. Je spôsobená
...
strom sa podieľa na hlasom na voľbe triedy vstupu $x$. S nárastom počtu stromov
...
postupne ustáli. Pri výbere náhodného vektora sa snažíme pri zachovaní jeho
...
\paragraph{Elitárstvo} je to proces pridávania chromozómov s najlepšou hodnotou
...
a ďalej distribuujú príkazy a vracajú sa s odozvou na ne~\cite{Seeley1991}.
...
zabezpečujú bezpečie svorky. Starejší sú skúsenými vlkmi, ktorí boli alfa alebo
...
príležitostne podieľať. V prírode vlky disponujú schopnosťou rozpoznať
...
robotnice, diváčky a prieskúmníčky. Včely si vymieňajú informácie o zdrojoch
...
Počet robotníc a diváčok je rovný počtu riešení v danej populácií. Každé
...
riešenie je lepšie ako predchádzajúce, včely si ho zapamätajú a predchádzajúce
...
hodnota chyby závisí od škály meraní, môže byť ovplyvnená transformáciami dát
a dobré predpovede majú hodnotu čo
najbližšiu 0~\cite{Agrawal2013, Gutierrez2015}.

\subsubsection{Stredná percentuálna chyba}
V označovaná ako MPE (mean percentage error). Matematicky môžeme túto funkciu
zapísať ako
\begin{equation}
...
ďalších algoritmov spôsobilo, čo možno najmenšie zmeny v pôvodnom systéme.
