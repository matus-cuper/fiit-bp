...
\begin{table}
  ...
  \begin{tabular}{|l|l|l|l|}
    ...
    \begin{tabular}[c]{@{}l@{}}Perception-Based \\ Computing\end{tabular}                         & \begin{tabular}[c]{@{}l@{}}Membrane \\ computing\end{tabular}                                   & \begin{tabular}[c]{@{}l@{}}Včelí zhlukovací \\ algoritmus\end{tabular}                       & Prílivové vlny                                                                                        \\
    \textbf{Wisdom Technology}                                                                    & \textbf{DNA computing}                                                                          & \begin{tabular}[c]{@{}l@{}}Vyhľadávanie \\ kukučkou\end{tabular}                             & Sopečné erupcie                                                                                       \\
    \begin{tabular}[c]{@{}l@{}}Anticipatory \\ Computing\end{tabular}                             &                                                                                                 & \begin{tabular}[c]{@{}l@{}}Inteligentná \\ kvapka vody\end{tabular}                          & Zemetrasenia                                                                                          \\
    \hline
  \end{tabular}
\end{table}
