...
a v kapitole~5 už samotnou implemntáciou systému v jazyku R.                    % \ref{implementation}
...
\begin{table}
  ...
  \begin{tabular}{|l|l|l|l|}
    ...
    Teória fuzzy množin                                                                           & Genetický algoritmus                                                                            & \begin{tabular}[c]{@{}l@{}}Optimalizácia \\ kolóniu mravcov\end{tabular}                     & Tektonické dosky                                                                                      \\
...
Dáta, ktoré budeme používať počas tvorby informačného systému, pochdázajú zo
...
zodpovedať norme ISO 8601. Námeraná hodnota bude reprezentovaná reálnym číslom.
